      ...
      <div className="bg-blue-100 pb-4">
        ...
        <div className="flex flex-row w-auto h-[500px] mb-5 mt-8 justify-between ml-24 mr-24 ">
          <div className=" bg-[#d9d9d9] w-[20em] rounded-lg text-lg font-semibold">
            ...
            <span className="ml-4 text-sm mb-4 mt-4">PAISE BADHAO,VRNA CHHOD KE CHALE JAYEGE, </span><br /> <span className="ml-4 text-sm mb-4 mt-4">FIR 400000 KHARCH KRNE PD JAYEGE </span>
          </div>
          <div className=" bg-[#d9d9d9] w-[20em] rounded-lg text-lg font-semibold">
            <span className="bg-[#273E47] rounded-t-lg flex flex-row justify-center text-white pb-4  px-4 ">
              <span className="mt-3">Notice for Staff</span>
            </span>
            <span className="ml-4 mt-4 text-sm mb-4">PAISE BADHAO,VRNA CHHOD KE CHALE JAYEGE, </span><br /> <span className="ml-4 mt-4 text-sm mb-4">FIR 400000 KHARCH KRNE PD JAYEGE </span>
          </div>
          <div className=" bg-[#d9d9d9] w-[20em] rounded-lg text-lg font-semibold">
            <span className="bg-[#273E47] rounded-t-lg flex flex-row justify-center text-white pb-4  px-4 ">
