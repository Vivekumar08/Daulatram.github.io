...
<div className="">
      ...
      <div>
        ...
        <a href="">5.RULES, REGULATIONS, INSTRUCTIONS, MANUAL AND RECORDS, FOR DISCHARGING FUNCTIONS</a>
        <a href="">6.A STATEMENT OF CATEGORIES OF DOCUMENT THAT ARE HELD BY IT FOR UNDER ITS CONTROL</a>
        <a href="">7.MODE OF PUBLIC PARTICIPATION:</a>
        <a href="">8.ADDRESS LIST OF THE TEACHING AND NON TEACHING STAFF</a>
        <a href="">9.THE MONTHLY REMUNERATION RECEIVED BY EACH OF ITS OFFICERS AND EMPLOYEES, INCLUDING THE SYSTEM OF COMPENSATION AS PROVIDED IN REGULATIONS</a>
        <a href="">10.The Budget Allocated to each Agency</a>
        <a href="">11.THE MANNER OF EXECUTION OF SUBSIDY PROGRAM</a>
        <a href="">12.PARTICULARS OF RECIPIENTS OF CONCESSIONS, PERMITS OR AUTHORIZATIONS GRANTED</a>
        <a href="">13.INFORMATION AVAILABLE IN AN ELECTRONIC FORM</a>
        <a href="">14.PARTICULARS OF FACILITIES AVAILABLE TO CITIZENS FOR OBTAINING INFORMATION</a>
        <a href="">15.NAME, DESIGNATION AND OTHER PARTICULARS OF PUBLIC INFORMATION OFFICERS</a>
