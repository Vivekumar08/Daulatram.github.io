...
function Eco_photogallery() {
  return (
    ...
    //         Photo Gallery
    //       </h2>
    //       <div class="flex flex-row justify-around mt-5 mb-5 ">
    //         <figure className="flex gap-4 pr-4 pl-4 pb-2">
    //           <img
    ...
    //         <figure className="flex gap-4 pr-4 pl-4 pb-2">
    //           <img
    //             src="/images/ImgPages/Economics/Image9.jpg"
    //             className="  mt-[3%]   w-[450px] h-[370px] rounded-2xl border-2 border-black"
    //           />
    ...
    //     <div className=" flex  flex-col mr-12 mt-32">
    //       <Economics />
    //     </div>
    //   </div>
    // </div>
