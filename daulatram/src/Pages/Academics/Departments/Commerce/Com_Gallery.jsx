...
function Com_Gallery() {
  ...
  const fetchdata = async () => {
    const response = await fetch("http://localhost:5000/Com_Photo_Gallery");
  ...
  const del = async (id) => {
    ...
    const response = await fetch(
      `http://localhost:5000/delete_Com_Photo_Gallery/${id}`,
      {
        method: "DELETE",
      }
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (file) {
        ...
        setErrMsg("");
        await axios.post(`http://localhost:5000/Com_Photo_Gallery_add`, formData, {
          headers: {
        ...
        <div className="name">
          <div className="">
            ...
            <div className=" bg-gray-400 pt-3 pb-3 pl-5 text-lg text-[#000080] mt-28 ">
              ...
              <span className="ml-5">Commerce</span>
