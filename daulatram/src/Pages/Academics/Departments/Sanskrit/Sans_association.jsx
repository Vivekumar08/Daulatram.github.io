        ...
        <div className="w-full mr-16">
          ...
          <div className="flex flex-col justify-center">
            <div>
              <img
                style={{
                  backgroundImage: "url(/images/ImgPages/Sanskrit/a1.jpg)",
                  width: "800px",
                  height: "600px",
                }}
            ...
            <div>
              <img
                style={{
                  backgroundImage: "url(/images/ImgPages/Sanskrit/a2.jpg)",
                  width: "800px",
                  height: "600px",
                }}
                className="bg-center bg-no-repeat mt-[1%] bg-cover h-10 mr-auto ml-auto mb-4 flex justify-center rounded-3xl border-2 border-black"
            ...
            <div>
              <img
                style={{
                  backgroundImage: "url(/images/ImgPages/Sanskrit/a3.jpg)",
                  width: "800px",
                  height: "600px",
                }}
                className="bg-center bg-no-repeat mt-[1%] bg-cover h-10 mr-auto ml-auto mb-4 flex justify-center rounded-3xl border-2 border-black"
            ...
            <div>
              <img
                style={{
                  backgroundImage: "url(/images/ImgPages/Sanskrit/a4.jpeg)",
                  width: "800px",
                  height: "600px",
                }}
                className="bg-center bg-no-repeat mt-[1%] bg-cover h-10 mr-auto ml-auto mb-4 flex justify-center rounded-3xl border-2 border-black"
            ...
            <div>
              <img
                style={{
                  backgroundImage: "url(/images/ImgPages/Sanskrit/a5.jpeg)",
                  width: "800px",
                  height: "600px",
                }}
                className="bg-center bg-no-repeat mt-[1%] bg-cover h-10 mr-auto ml-auto mb-4 flex justify-center rounded-3xl border-2 border-black"
            ...
            <div>
              <img
                style={{
                  backgroundImage: "url(/images/ImgPages/Sanskrit/a6.jpeg)",
                  width: "800px",
                  height: "600px",
                }}
                className="bg-center bg-no-repeat mt-[1%] bg-cover h-10 mr-auto ml-auto mb-4 flex justify-center rounded-3xl border-2 border-black"
