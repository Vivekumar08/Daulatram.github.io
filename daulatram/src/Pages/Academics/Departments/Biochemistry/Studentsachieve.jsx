            ...
            <div className="">
              ...
              <div>
                <ol className="list-decimal mt-2 ml-8">
                  <li>
                    Shefali Jain, Best poster, DST Inspire Science Conclave
                    2019: Research on the Frontier, Miranda House, 16 January to
                    18 January 2019.
                  </li>

                  <li>
                    Pratiksha, Best poster, DBT Biotechnology meet, Miranda
                    house 2nd august 2019
                  </li>
              ...
              <ol className="list-decimal ml-8">
                ...
                <li>
                  Soanli Gupta (2019) Pursuing Integrated M.Sc-PhD from IISER
                  Pune.
                </li>
                <li>
                ...
                <li>
                  Parul Mittal (2016) MSc biotechnology and now pursuing PhD
                  from INMAS and DU.
                </li>
                <li>
                ...
                <li>
                  ...
                  Assistant Professor, Banaras Hindu University , BHU TRBB.
                </li>
