          ...
          <div className="">
            ...
            <ol className="list-decimal mt-2 ml-10 mr-4 text-justify mb-4">
              ...
              <p>
                ...
                held on the online platform.Course coordinator: Dr Sarita Nanda
                (TIC, biochemistry department) Duration with dates: The SDP was
                help from 11:00 am to 1:00 pm from 19th to 21st August 2020
              </p>
              <br />
              <li>
                <strong>
                  Report on SDP held by Department of Biochemistry from 17th
                  December 2020 to 19th December 2020 titled E-skill development
                  program on enhanced learning through ICT tools.
                </strong>
              </li>
              <br />
              <p>
                ...
                held on the online platform. Course coordinator: Dr Sarita Nanda
                (TIC, biochemistry department) Duration with dates: The SDP was
                help from 11:00 am to 1:00 pm from 17th to 19th December 2020
              </p>
              <br />
              <li>
                The Biochemistry department festival{" "}
                <strong>BIOMANIA 2020-21 was held on 13 February 2021 </strong>{" "}
              ...
              <li>
                ...
                Biochemistry, Daulat Ram College. Covid 19 pandemic has impacted
                the whole world and the key to prevent the spread is early
                detection. We were very fortunate to have with us Dr Debojyoti
                Chakraborty and his team who have been pioneers in indigenously
                developing CRISPR based COVID-19 detection kit which is now
                popularly known as Feluda.
              </li>
              <br />
            </ol>
            <div>
            ...
            <ol className="list-decimal mt-2 ml-10 mr-4 text-justify mb-4">
              <li>
                ...
                <strong> Meet the scientist series</strong> on 10th April, 2019
              </li>
            </ol>
            ...
            <ol className="list-decimal mt-2 ml-10 mr-4 text-justify mb-4">
              <li>
                <strong>
                  {" "}
                  BIOMANIA18, an intracollege Science festival was organized by
                  Biochemistry department on 20th Feb, 2018.
                </strong>{" "}
                Various events like Poster presention on “Future Technologies”,
                Just a minute, and Dumb Charades were organized. Under{" "}
                <strong>
